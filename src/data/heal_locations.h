static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 35, 15},
};
